    ...
    <v-container>
      <v-card class="pa-3 mt-15 elevation-5">
        <v-card-text class="d-flex justify-space-between align-center">
          <v-card-title> Tags ( {{ tags.length }} ) </v-card-title>
          <v-card-actions>
            <nuxt-link to="/admin/tags/create-tag">
          ...
          <div v-else>
            <v-simple-table>
              <template v-slot:default>
                ...
                <tbody>
                  <tr v-for="(tag, index) in new_page_items" :key="index">
                    <td class="">{{ index + 1 }}</td>
                    ...
                    <td class="">{{ tag.views }}</td>
                    <td class="">
                      <div v-if="tag.status == 'true'">
                    ...
                    <td class="">
                      <nuxt-link :to="`/admin/tags/update-tag/${tag.id}`">
        ...
        <v-card-actions class="justify-center pt-3 mb-5">
          <div class="pagination">
            ...
            <v-btn
              ...
              text
              outlined
              v-if="this.num_per_page * (this.page + 1) < this.tags.length"
              v-on:click="set_page(+1)"
              >{{ page + 2 }}</v-btn
            >
            <v-btn
              ...
              text
              outlined
              v-if="this.num_per_page * (this.page + 2) < this.tags.length"
              v-on:click="set_page(+2)"
              >{{ page + 3 }}</v-btn
            >
            <v-btn
