...
export default {
  ...
  methods: {
    ...mapActions({
      updateSlide: "slides/updateSlide",
    }),
    onChangeFile(e) {
      this.new_image = e;
    },
  ...
  async mounted(_) {
    ...
    const res = await axios.put(
      `http://localhost:8000/api/admin/slides/${this.$route.params.slideid}`,
      _,
      config
    );
