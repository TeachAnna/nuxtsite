...
export default {
  ...
  methods: {
    ...mapActions({
      updateAccordion: "accordions/updateAccordion",
    }),
    onChangeFile(e) {
      this.new_image = e;
    },
  ...
  async mounted(_) {
    ...
    const res = await axios.put(
      `http://localhost:8000/api/admin/accordions/${this.$route.params.accordionid}`,
      _,
      config
    );
